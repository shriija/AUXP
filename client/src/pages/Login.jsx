...
export default function Login() {
  ...
  return (
    <div className="flex-1 flex items-center justify-center p-4 h-full my-auto">
      ...
      >
        <div className="absolute top-0 left-0 w-full h-2 bg-primary border-b-4 border-black" />
        <div className="p-8 mt-2">
          <div className="flex justify-center mb-6">
            <div className="h-16 w-16 bg-secondary rounded-full flex items-center justify-center border-4 border-black shadow-neo-sm">
              <BrainCircuit className="h-8 w-8 text-black" />
            </div>
          </div>
          <h2 className="text-2xl font-black text-center mb-2">Welcome back</h2>
          <p className="text-center font-medium text-black/70 mb-8 text-sm">Enter your credentials to access the vault</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                type="email"
                required
                className="w-full bg-white border-2 border-black rounded-neo px-4 py-2.5 outline-none focus:shadow-neo-sm focus:bg-yellow-50 transition-all font-medium text-black placeholder:text-black/40"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-primary text-black font-black py-3 rounded-neo border-2 border-black shadow-neo hover:translate-y-[2px] hover:shadow-neo-sm transition-all flex justify-center items-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed mt-6"
            >
          ...
          <div className="mt-8 text-center text-sm font-semibold text-black/70">
            ...
            <Link to="/register" className="text-black hover:text-primary hover:underline font-black">Create one</Link>
          </div>
        </div>
      </motion.div>
    </div>
