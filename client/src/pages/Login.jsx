      ...
      >
        ...
        <div className="p-8 mt-2">
          <div className="flex justify-center mb-6">
            <div className="h-14 w-14 bg-primary/10 rounded-full flex items-center justify-center border border-primary/20 shadow-sm">
              <BrainCircuit className="h-6 w-6 text-primary" />
            </div>
          </div>
          <h2 className="text-xl font-extrabold text-center text-slate-800 mb-1">Welcome back</h2>
          <p className="text-center font-medium text-slate-400 mb-8 text-xs">Enter your credentials to access the vault</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-xs font-semibold mb-1.5 text-slate-650">Email</label>
              <input
                type="email"
                required
            ...
            <div>
              <label className="block text-xs font-semibold mb-1.5 text-slate-650">Password</label>
          ...
          <div className="mt-8 text-center text-xs font-semibold text-slate-400">
            ...
            <Link to="/register" className="text-slate-600 hover:text-primary transition-colors font-bold">Create one</Link>
          </div>
        </div>
      </motion.div>
    </div>
